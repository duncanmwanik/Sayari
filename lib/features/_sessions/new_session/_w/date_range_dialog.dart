                ...
                Align(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      AppButton(
                        onPressed: () async {
                          await showSelectDateDialog(title: 'Select start date', initialDate: input.dateRangeStart, showTitle: true).then((dates) async {
                            if (dates.isNotEmpty) {
                      ...
                      AppButton(
                        onPressed: () async {
                          await showSelectDateDialog(title: 'Select end date', initialDate: input.dateRangeStart, showTitle: true).then((dates) async {
                            if (dates.isNotEmpty) {
