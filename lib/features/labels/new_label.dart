...
class NewlabelInput extends StatefulWidget {
  const NewlabelInput(
      {super.key, this.isPopup = false, this.isSelection = false});
    ...
    return Row(
      children: [
        ...
        AppButton(
          ...
          noStyling: true,
          isSquare: true,
          child: AppIcon(showSaveButton ? closeIcon : Icons.add_rounded,
              faded: true, size: 18),
        ),
        //
        Expanded(
          child: Padding(
            ...
            child: DataInput(
              ...
              color: transparent,
              contentPadding: EdgeInsets.only(left: 10, top: 10, bottom: 5),
            ),
          ),
        ),
        //
