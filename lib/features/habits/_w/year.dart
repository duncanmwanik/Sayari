...
class HabitYear extends StatelessWidget {
  const HabitYear({super.key, this.item});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      AppButton(
                        onPressed: () =>
                            swipeToNew(isSwipeRight: true, view: 3),
                        child: AppIcon(Icons.keyboard_arrow_left),
                      ),
                      //
                      AppText(
                          size: normal,
                          text: dateTime.selectedYear.toString(),
                          fontWeight: FontWeight.bold),
                      //
                      AppButton(
                        onPressed: () =>
                            swipeToNew(isSwipeRight: false, view: 3),
                        ...
                        if (snapshot.connectionState == ConnectionState.done) {
                          if (snapshot.hasError) {
                            return Padding(
                              ...
                              child: Center(
                                  child: AppText(
                                      text: 'Refresh screen...', faded: true)),
                            );
                          } else if (snapshot.hasData) {
                            Map<int, Map<int, String>> allMonthsDateMap =
                                snapshot.data as Map<int, Map<int, String>>;

                            return Column(
                              mainAxisSize: MainAxisSize.min,
                              children: List.generate(12, (indexMonth) {
                                Map<int, String> monthMap =
                                    allMonthsDateMap[indexMonth] ?? {};
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    AppText(
                                        size: normal,
                                        text: getMonthFull(monthMap[14] ?? ''),
                                        faded: true),
                                    mph(),
                                    //
                                    WeekLabels(width: width, isInput: isInput),
                                    //
                                    sph(),
                                    //
                                    Consumer<InputProvider>(
                                      ...
                                      List<String> customDates = isCustom
                                          ? getSplitList(data['hd'])
                                          : [];
                                      ...
                                      return Wrap(
                                        ...
                                        runSpacing: 2,
                                        children:
                                            List.generate(42, (indexDate) {
                                          DateInfo date = DateInfo(
                                              getDatePart(monthMap[indexDate]));
                                          String checkedKey = 'hc${date.d()}';
                                          bool isCustomDate =
                                              customDates.contains(date.d());
                                          bool isChecked =
                                              data[checkedKey] != null &&
                                                  data[checkedKey] != '0';
