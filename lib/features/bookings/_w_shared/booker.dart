...
import '../../auth/_vars/variables.dart';
...
class _ShareScreenState extends State<Booker> {
  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedBox(
      ...
      child: isDone
          ? SharedItemInfo(label: 'Your session with ${widget.userName} has been booked.')
          : Form(
              key: bookingFormKey,
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    //
                    Align(alignment: Alignment.topLeft, child: AppText(text: 'Book a session...', size: medium, faded: true, fontWeight: FontWeight.w700)),
                    mph(),
                    tph(),
                    SfCalendar(
