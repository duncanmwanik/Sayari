...
DefaultStyles getQuillEditorStyle({bool isOverview = false, String? bgColor}) {
  ...
  return DefaultStyles(
    placeHolder: DefaultTextBlockStyle(
      TextStyle(fontSize: isOverview ? 13 : 16, height: 1.3, color: quillFadedTextColor, fontFamily: fontFamily, fontWeight: fontWeight),
      VerticalSpacing(0, 0),
      VerticalSpacing(0, 0),
      null,
    ),
    leading: DefaultTextBlockStyle(
      TextStyle(fontSize: isOverview ? 13 : 16, height: 1.3, color: quillTextColor, fontFamily: fontFamily, fontWeight: fontWeight),
      VerticalSpacing(0, 0),
      VerticalSpacing(0, 0),
      null,
    ),
      ...
      child: InkWell(
        ...
        child: ConstrainedBox(
          ...
          child: Container(
            ...
            child: Center(
              child: isChecked ? AppIcon(Icons.done_rounded, size: isOverview ? 8 : 12, faded: true, color: isChecked ? white : null) : NoWidget(),
            ),
          ),
        ),
      ),
