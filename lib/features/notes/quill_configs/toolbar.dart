  ...
  return Consumer<QuillProvider>(builder: (context, quill, child) {
    ...
    return Wrap(
      ...
      children: [
        ...
        mspw(),
        if (full) QuillToolbarToggleStyleButton(controller: quillcontroller, attribute: Attribute.italic, options: options),
        if (full) mspw(),
        if (full) QuillToolbarToggleStyleButton(controller: quillcontroller, attribute: Attribute.underline, options: options),
        if (full) mspw(),
        ...
        if (full) mspw(),
        if (full) QuillToolbarLinkStyleButton(controller: quillcontroller, options: QuillToolbarLinkStyleButtonOptions(iconTheme: iconTheme, iconSize: iconSize)),
        if (full) mspw(),
        if (full) QuillToolbarToggleStyleButton(controller: quillcontroller, attribute: Attribute.codeBlock, options: options),
        if (full) mspw(),
