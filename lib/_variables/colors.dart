...
class ColorObject {
  const ColorObject({required this.color, required this.shadeColor, required this.textColor, this.isThemeAccent = false});
  final Color color;
...
Map<String, ColorObject> backgroundColors = {
  ...
  '6': ColorObject(color: Colors.purple, shadeColor: Colors.purple.shade200, textColor: Colors.white, isThemeAccent: true),
  '7': ColorObject(color: Colors.brown, shadeColor: Colors.brown.shade200, textColor: Colors.white, isThemeAccent: true),
  ...
  '12': ColorObject(color: Colors.deepOrange, shadeColor: Colors.deepOrange.shade200, textColor: Colors.white, isThemeAccent: true),
