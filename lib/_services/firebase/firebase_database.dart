...
class CloudData {
  static const String tablesUrl = 'https://sayaritables.europe-west1.firebasedatabase.app/';
  ...
  final Map<String, DatabaseReference> refs = {
    ...
    'tables': FirebaseDatabase.instanceFor(app: Firebase.app(), databaseURL: tablesUrl).ref(),
